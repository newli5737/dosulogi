...
import { UserModal } from '../../user-modal/ui/UserModal'
...
export function UserTable() {
  ...
  const fetchPage = useCallback((page, limit) => userApi.list(token, page, limit), [token])
  const { rows, meta, page, setPage, loading, reload } = usePaginated(fetchPage, { enabled: isAdmin })
